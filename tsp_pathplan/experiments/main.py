...
def delete_existing_files_and_folders():
    # Folders to delete
    folders = ['results', 'identified_images_VLM', '../benchmark-UAV-VLPA-nano-30/identified_images_mp']
    # Files to delete
    files = ['home_position.txt', 'VLM_coordinates.txt', 'mp_coordinates.txt', 'rmse.txt', 'traj_length.txt']
...
def main():
    ...
    delete_existing_files_and_folders()
    ...
    results_file = '../Astar_coordinates.txt'
